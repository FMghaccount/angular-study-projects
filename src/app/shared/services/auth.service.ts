...
export class AuthService {
  ...
  signUp(email: string, password: string) {
    return this.http.post<AuthResponseData>(
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDbqrYtTEC_uyE8KT0TSzeJZ5haT388SWA',
      {
        email: email,
        password: password,
  ...
  signIn(email: string, password: string) {
    return this.http.post<AuthResponseData>(
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDbqrYtTEC_uyE8KT0TSzeJZ5haT388SWA',
      {
        email: email,
        password: password,
        returnSecureToken: true
